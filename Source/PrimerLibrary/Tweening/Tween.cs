...
namespace PrimerLibrary
{
        ...
        : ITweenable
    {
        ...
        {
            varHash.Add(info.MemberName ?? string.Empty, vars.Count);
            vars.Add(info);
        ...
        public void UpdateTween(float elapsed)
        {
            if (firstUpdate)
            {
                firstUpdate = false;
        ...
        /// <returns>A reference to this.</returns>
        public ITweenable Ease(Func<float, float> ease)
        {
            this.ease = ease;
            return this;
        }
        ...
        /// <returns>A reference to this.</returns>
        public ITweenable OnBegin(Action callback)
        {
            switch (begin)
            {
                case null:
        ...
        /// <returns>A reference to this.</returns>
        public ITweenable OnUpdate(Action callback)
        {
            switch (update)
            {
                case null:
        ...
        /// <returns>A reference to this.</returns>
        public ITweenable OnComplete(Action callback)
        {
            switch (complete)
            {
                case null:
        ...
        /// <returns>A reference to this.</returns>
        public ITweenable Repeat(int times = -1)
        {
            repeatCount = times;
            return this;
        }
        ...
        /// <returns>A reference to this.</returns>
        public ITweenable RepeatDelay(float delay)
        {
            repeatDelay = delay;
            return this;
        }
