...
public static partial class Operations
{
    ...
    /// </summary>
    /// <param name="x">A T-precision floating-point number to find the specified root of.</param>
    /// <param name="y">A T-precision floating-point number that specifies a root.</param>
    /// <returns>
